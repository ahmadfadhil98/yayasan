            ...
            <div class="flex">
                ...
                <div class="flex-shrink-0 flex items-center">
                    ...
                    {{-- <x-jet-application-mark class="block w-auto h-9" /> --}}
                        <img src="{{url('/img/logo LPH.png')}}" width="64">
                    </a>
                </div>
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
        <div class="pt-2 pb-3 space-y-1">
            <x-jet-responsive-nav-link href="{{ route('dashboard') }}" :active="request()->routeIs('dashboard')">
                <span class="text-orange-400 font-bold">Home</span>
        ...
        <div class="pt-4 pb-1 border-t border-gray-200">
            ...
            <div class="mt-3 space-y-1">
                ...
                <x-jet-responsive-nav-link href="{{ route('certificate') }}" :active="request()->routeIs('certificate')">
                    <span class="text-orange-400 font-bold">Sertifikat</span>
                </x-jet-responsive-nav-link>

                <x-jet-responsive-nav-link href="{{ route('referensi') }}" :active="request()->routeIs('referensi')">
                    <span class="text-orange-400 font-bold">Referensi</span>
                </x-jet-responsive-nav-link>
                ...
                <form method="POST" action="{{ route('logout') }}">
                    ...
                    <x-jet-responsive-nav-link href="{{ route('logout') }}"
                                    onclick="event.preventDefault();
                                                this.closest('form').submit();">
                        <span class="text-orange-400 font-bold">Logout</span>
                    </x-jet-responsive-nav-link>
                </form>

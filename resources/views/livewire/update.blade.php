            ...
            <form>
                <div class="sm:py-6 sm:px-6">
                    <div>
                        ...
                        <h2 class="mb-4 text-xl font-bold text-center text-gray-600">UPDATE STATUS</h2>
                    </div>
                    <div>
                        <div>
                        ...
                        <div class="mb-2">
                            ...
                            <input wire:model="id_reg" type="number" name="id_reg" class="w-full py-2.5 px-4 text-sm text-gray-600 rounded-xl focus:outline-none mb-2 shadow-md" placeholder="Input Id Reg Biaya">
                        ...
                        <div class="mb-2">
                            <div class="flex mb-2 text-sm font-bold text-gray-600">
                                ...
                                <div class="ml-3">LPH Mapped Id</div>
                            </div>
                            <input wire:model="lph_mapped_id" name="lph_mapped_id" class="w-full py-2.5 px-4 text-sm text-gray-600 rounded-xl focus:outline-none mb-2 shadow-md" placeholder="Input LPH Mapped Id">
                            @error('lph_mapped_id') <h1 class="text-red-500">{{$message}}</h1>@enderror
                        </div>
                ...
                <div class="px-6 mb-10">
                    <span class="flex w-full mb-3">
                        <button style="background-color: #078CAA;" wire:click.prevent="storeUpdate()" type="button" class="transform hover:scale-95 duration-300 inline-flex justify-center w-full py-2.5 text-sm leading-6 text-white focus:outline-none rounded-xl shadow-md">
                            Simpan
                        </button>
                    </span>

                ...
                <div class="sm:py-6 sm:px-6">
                    ...
                    <div>
                        ...
                        <div class="mb-2">
                            ...
                            <input wire:model="create_by" name="create_by" class="w-full py-2.5 px-4 text-sm text-gray-600 rounded-xl focus:outline-none mb-2 shadow-md" placeholder="Input Create By">

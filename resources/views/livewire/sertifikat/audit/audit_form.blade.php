            ...
            <form>
                <div class="sm:py-6 sm:px-6">
                    <div>
                        ...
                        <h2 class="mb-4 text-xl font-bold text-center text-gray-600">TAMBAH JADWAL AUDIT</h2>
                    </div>
                    <div>
                        <div>
                        ...
                        <div class="mb-2">
                            <div class="flex mb-2 text-sm font-bold text-gray-600">
                                ...
                                <div class="ml-3">Jadwal Awal</div>
                            </div>
                            <input wire:model="jadwal_awal" type="date" name="jadwal_awal" class="w-full py-2.5 px-4 text-sm text-gray-600 rounded-xl focus:outline-none mb-2 shadow-md" placeholder="Input Jadwal Awal Audit">
                            @error('jadwal_awal') <h1 class="text-red-500">{{$message}}</h1>@enderror
                        </div>
                        ...
                        <div class="mb-2">
                            <div class="flex mb-2 text-sm font-bold text-gray-600">
                                ...
                                <div class="ml-3">Jadwal Akhir</div>
                            </div>
                            <input wire:model="jadwal_akhir" type="date" name="jadwal_akhir" class="w-full py-2.5 px-4 text-sm text-gray-600 rounded-xl focus:outline-none mb-2 shadow-md" placeholder="Input Jadwal Akhir Audit">

                            @error('jadwal_akhir') <h1 class="text-red-500">{{$message}}</h1>@enderror
                        </div>
                        ...
                        <div class="mb-2">
                            <div class="flex mb-2 text-sm font-bold text-gray-600">
                                ...
                                <div class="ml-3">Jumlah Hari</div>
                            </div>
                            <input wire:model="jml_hari" type="number" name="jml_hari" class="w-full py-2.5 px-4 text-sm text-gray-600 rounded-xl focus:outline-none mb-2 shadow-md" placeholder="Input Jumlah Hari Audit">

                            @error('jml_hari') <h1 class="text-red-500">{{$message}}</h1>@enderror
                        </div>
                    </div>
                ...
                <div class="px-6 mb-10">
                    <span class="flex w-full mb-3">
                        <button style="background-color: #078CAA;" wire:click.prevent="storeAudit()" type="button" class="transform hover:scale-95 duration-300 inline-flex justify-center w-full py-2.5 text-sm leading-6 text-white focus:outline-none rounded-xl shadow-md">
                            Simpan
                        </button>
                    </span>

            ...
            <form>
                <div class="sm:py-6 sm:px-6">
                    <div>
                        ...
                        <h2 class="mb-4 text-xl font-bold text-center text-gray-600">LAPORAN AUDIT</h2>
                    </div>
                    <div>
                        <div>
                        ...
                        <div class="mb-2">
                            ...
                            <input wire:model="file" type="file" name="file" class="w-full py-2.5 px-4 text-sm text-gray-600 rounded-xl focus:outline-none mb-2 shadow-md" placeholder="File Hasil Audit">
                        ...
                        <div class="mb-2">
                            <div class="flex mb-2 text-sm font-bold text-gray-600">
                                ...
                                <div class="ml-3">Tanggal Selesai</div>
                            </div>
                            <input wire:model="tgl_selesai" type="date" name="tgl_selesai" class="w-full py-2.5 px-4 text-sm text-gray-600 rounded-xl focus:outline-none mb-2 shadow-md" placeholder="Input Tanggal Selesai Audit">
                            @error('tgl_selesai') <h1 class="text-red-500">{{$message}}</h1>@enderror
                        </div>
                        ...
                        <div class="mb-2">
                            <div class="flex mb-2 text-sm font-bold text-gray-600">
                                ...
                                <div class="ml-3">Hasil Audit</div>
                            </div>
                            <input wire:model="hasil_audit" name="hasil_audit" class="w-full py-2.5 px-4 text-sm text-gray-600 rounded-xl focus:outline-none mb-2 shadow-md" placeholder="Input Hasil Audit">
                            @error('hasil_audit') <h1 class="text-red-500">{{$message}}</h1>@enderror
                        </div>
                        ...
                        <div class="mb-2">
                            ...
                            {{ Form::select('keterangan',['LULUS'=>'LULUS','TIDAK LULUS'=>'TIDAK LULUS'],null,
                ...
                <div class="px-6 mb-10">
                    <span class="flex w-full mb-3">
                        <button style="background-color: #078CAA;" wire:click.prevent="storeLaporan()" type="button" class="transform hover:scale-95 duration-300 inline-flex justify-center w-full py-2.5 text-sm leading-6 text-white focus:outline-none rounded-xl shadow-md">
                            Simpan
                        </button>
                    </span>
